...
ALTER TABLE quests ADD COLUMN IF NOT EXISTS day               INT;
ALTER TABLE quests ADD COLUMN IF NOT EXISTS title             TEXT;
ALTER TABLE quests ADD COLUMN IF NOT EXISTS reward_crystals   INT NOT NULL DEFAULT 0;
ALTER TABLE quests ADD COLUMN IF NOT EXISTS is_mega           BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE quests ADD COLUMN IF NOT EXISTS type              TEXT NOT NULL DEFAULT 'manual';
